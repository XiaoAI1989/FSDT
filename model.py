...
class DecisionTransformer(nn.Module):
    ...
    def forward(self, states, actions, rewards_to_go, timesteps):
        ...
        # predict state given the decoded token of action, which contains information about previous transitions and current r, s, a
        state_preds = self.predict_state(h[:,2])
        # predict rtg given the decoded token of action, which contains information about previous transitions and current r, s, a
